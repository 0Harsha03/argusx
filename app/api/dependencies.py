...
async def get_pipeline(request: Request) -> DetectionPipeline:
    """
    Retrieve the DetectionPipeline from app.state.
    ...
    if pipeline is None:
        request.app.state._pipeline = DetectionPipeline(registry)
